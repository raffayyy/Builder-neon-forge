...
class NewsService {
  ...
  private readonly FALLBACK_NEWS: NewsArticle[] = [
    {
      ...
      description: 'A breakthrough framework combining the best of React and Vue.js approaches, offering unprecedented developer experience and performance optimizations.',
    ...
    },
    {
      ...
      description: 'Latest advancements in AI coding assistants show remarkable improvement in code suggestion accuracy, transforming how developers write code.',
    ...
    },
    {
      ...
      description: 'Major enterprises are increasingly adopting WebAssembly for performance-critical web applications, leading to significant speed improvements.',
    ...
    },
    {
      ...
      description: 'The latest TypeScript release brings advanced type inference and compile-time optimizations that dramatically improve developer productivity.',
    ...
    },
    {
      ...
      description: 'Revolutionary cloud optimization platforms help companies reduce infrastructure costs while maintaining performance and reliability.',
    ...
    },
    {
      ...
      description: 'New quantum algorithms promise to revolutionize encryption and security protocols across the technology industry.',
  ...
  async fetchTechNews(category: string = 'technology', pageSize: number = 20): Promise<NewsResponse> {
    try {
  ...
  async searchNews(query: string, pageSize: number = 20): Promise<NewsResponse> {
    try {
